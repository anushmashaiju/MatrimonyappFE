...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        // Remove background class on component unmount
        return () => {
    ...
    useEffect(() => {
        ...
        const fetchPersonalDetails = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/user/currentpersonal-details/${userId}`, { withCredentials: true });
        ...
        const fetchPartnerPreferences = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/user/currentpartnerpreferences/${userId}`, { withCredentials: true });
    ...
    }, [userId]); // Include userId in dependency array to fetch data when it changes
    ...
    const handleCreateClick = () => {
        navigate('/create'); // Navigate to profile creation page
    };

    const handlePreferenceClick = () => {
        navigate('/preference'); // Navigate to partner preferences page
    };
