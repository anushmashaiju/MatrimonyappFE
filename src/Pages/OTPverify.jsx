...
function OTPverify() {
  ...
  const handleSendOtp = async () => {
    try {
      const response = await axios.post('http://localhost:8000/auth/send-otp', { phoneNumber });
  ...
  const handleVerifyOtp = async () => {
    try {
      const response = await axios.post('http://localhost:8000/auth/verify-otp', { phoneNumber, otp });
